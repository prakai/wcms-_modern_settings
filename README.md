...
2. Create folder named "__modern_settings" in WonderCMS plugins folder. IMPORTANT!! Plugin folder name must begin with "__", force to load this plugin at the first. 
